...
// $sql = "SELECT * FROM tbl_produtos ORDER BY id_produtos DESC";
...
<body>
    <header>
        ...
        <a href="indexlogin.php"><button class="login">Login</button></a>
    </header>
        ...
        <div class="content">
            ...
            <div class="serv">
                ...
                <div class="text_list2">
                    <h3 class="h3_footer2"><strong>Banho e tosa</strong></h3>
