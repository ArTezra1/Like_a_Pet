...
$result = mysqli_query($conexao, "SELECT id_agendamentos, Datas, Hora, id_clientes, id_animais FROM $tabelaa");
...
<nav class="m-3">
    ...
    <div class="m-3 maca">
        ...
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">Id_agendamento</th>
